...
| **6.5b** | **Escort / delivery** — a two-endpoint errand (deliver a person/parcel/message from here to a destination). Structurally distinct (origin **and** destination), so split out. | ◻ |
