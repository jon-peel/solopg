...
export const TERRAIN_PROFILE = {
  Forest: {
    ...
    poi: { chance: 0.55, count: "1d3", weights: { lair: 4, ruin: 3, shrine: 2, camp: 2, dungeon: 2, landmark: 1, tower: 1 } },
  },
  Plains: {
    settlement: { chance: 0.45, maxSize: "City" },
    poi: { chance: 0.4, count: "1d2", weights: { ruin: 3, shrine: 2, camp: 3, landmark: 2, lair: 1, tower: 1 } },
  },
  Hills: {
    settlement: { chance: 0.35, maxSize: "Town" },
    poi: { chance: 0.55, count: "1d3", weights: { mine: 4, lair: 3, ruin: 2, dungeon: 2, tower: 2, shrine: 1 } },
  },
  Mountains: {
    settlement: { chance: 0.15, maxSize: "Hamlet" },
    poi: { chance: 0.6, count: "1d3", weights: { mine: 4, dungeon: 3, lair: 3, tower: 2, ruin: 2, shrine: 1 } },
  },
  Swamp: {
    settlement: { chance: 0.15, maxSize: "Hamlet" },
    poi: { chance: 0.55, count: "1d2", weights: { lair: 4, ruin: 3, shrine: 2, dungeon: 2, landmark: 1 } },
  },
  Desert: {
    settlement: { chance: 0.2, maxSize: "Town" },
    poi: { chance: 0.45, count: "1d2", weights: { ruin: 4, shrine: 3, lair: 2, landmark: 2, tower: 1, mine: 1 } },
  },
  Water: {
    settlement: null, // no settlements on open water
    poi: { chance: 0.2, count: "1d2", weights: { ruin: 2, landmark: 2, shrine: 1, lair: 1 } },
  },
};

const DEFAULT_PROFILE = {
  settlement: { chance: 0.25, maxSize: "City" },
  poi: { chance: 0.4, count: "1d2", weights: { ruin: 2, landmark: 1 } },
};
